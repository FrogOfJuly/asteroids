...
function __wbg_adapter_26(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he1e540767b799e4b(arg0, arg1);
}
...
const CursiveFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_cursive_free(ptr >>> 0, 1));
...
export class Cursive {
    ...
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        CursiveFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        CursiveFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_cursive_free(ptr, 0);
    }
    /**
     * @returns {Promise<Cursive>}
     */
    static asteroids() {
        const ret = wasm.cursive_asteroids();
        return ret;
    }
    /**
     ...
     * @returns {Promise<Cursive>}
     */
    static asteroids_with_canvas(canvas) {
        const ret = wasm.cursive_asteroids_with_canvas(canvas);
        return ret;
    }
}

const ScreenCharFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_screenchar_free(ptr >>> 0, 1));
...
export class ScreenChar {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ScreenCharFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_screenchar_free(ptr, 0);
    }
}
...
export function __wbg_alert_7bf44fdac88ac590(arg0, arg1) {
...
export function __wbg_paint_98243ca071cd1cb1(arg0, arg1) {
...
export function __wbg_settitle_4f2894dde356c096(arg0, arg1, arg2) {
